...
type SSMPatchBaselineProperties struct {
	...
	RejectedPatchesAction            interface{} `yaml:"RejectedPatchesAction,omitempty"`
	ApprovalRules                    interface{} `yaml:"ApprovalRules,omitempty"`
	GlobalFilters                    interface{} `yaml:"GlobalFilters,omitempty"`
