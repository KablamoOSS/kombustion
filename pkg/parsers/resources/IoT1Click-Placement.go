...
func (resource IoT1ClickPlacementProperties) Validate() []error {
	errors := []error{}
	if resource.PlacementName == nil {
		errors = append(errors, fmt.Errorf("Missing required field 'PlacementName'"))
	}
	if resource.ProjectName == nil {
		errors = append(errors, fmt.Errorf("Missing required field 'ProjectName'"))
	}
	return errors
}
