...
func (resource IoT1ClickProjectProperties) Validate() []error {
	...
	if resource.PlacementTemplate == nil {
		errors = append(errors, fmt.Errorf("Missing required field 'PlacementTemplate'"))
	} else {
		errors = append(errors, resource.PlacementTemplate.Validate()...)
	}
	return errors
}
