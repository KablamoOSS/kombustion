...
type CognitoUserPoolProperties struct {
	...
	SmsConfiguration         interface{} `yaml:"SmsConfiguration,omitempty"`
	...
	LambdaConfig             interface{} `yaml:"LambdaConfig,omitempty"`
	EmailConfiguration       interface{} `yaml:"EmailConfiguration,omitempty"`
	DeviceConfiguration      interface{} `yaml:"DeviceConfiguration,omitempty"`
	AdminCreateUserConfig    interface{} `yaml:"AdminCreateUserConfig,omitempty"`
}
