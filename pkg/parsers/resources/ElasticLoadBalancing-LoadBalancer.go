...
type ElasticLoadBalancingLoadBalancerProperties struct {
	...
	ConnectionSettings        interface{} `yaml:"ConnectionSettings,omitempty"`
	ConnectionDrainingPolicy  interface{} `yaml:"ConnectionDrainingPolicy,omitempty"`
	AccessLoggingPolicy       interface{} `yaml:"AccessLoggingPolicy,omitempty"`
}
