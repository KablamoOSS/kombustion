...
type AppSyncGraphQLApiProperties struct {
	...
	UserPoolConfig      interface{} `yaml:"UserPoolConfig,omitempty"`
	OpenIDConnectConfig interface{} `yaml:"OpenIDConnectConfig,omitempty"`
	LogConfig           interface{} `yaml:"LogConfig,omitempty"`
}
