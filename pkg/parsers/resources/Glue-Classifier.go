...
type GlueClassifierProperties struct {
	XMLClassifier  interface{} `yaml:"XMLClassifier,omitempty"`
	JsonClassifier interface{} `yaml:"JsonClassifier,omitempty"`
	GrokClassifier interface{} `yaml:"GrokClassifier,omitempty"`
}
