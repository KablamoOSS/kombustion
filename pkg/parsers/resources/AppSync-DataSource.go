...
type AppSyncDataSourceProperties struct {
	...
	RelationalDatabaseConfig interface{} `yaml:"RelationalDatabaseConfig,omitempty"`
	LambdaConfig             interface{} `yaml:"LambdaConfig,omitempty"`
	HttpConfig               interface{} `yaml:"HttpConfig,omitempty"`
	ElasticsearchConfig      interface{} `yaml:"ElasticsearchConfig,omitempty"`
	DynamoDBConfig           interface{} `yaml:"DynamoDBConfig,omitempty"`
}
