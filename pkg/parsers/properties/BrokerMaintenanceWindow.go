...
func (resource BrokerMaintenanceWindow) Validate() []error {
	...
	if resource.DayOfWeek == nil {
		errs = append(errs, fmt.Errorf("Missing required field 'DayOfWeek'"))
	}
	if resource.TimeOfDay == nil {
		errs = append(errs, fmt.Errorf("Missing required field 'TimeOfDay'"))
	}
	if resource.TimeZone == nil {
		errs = append(errs, fmt.Errorf("Missing required field 'TimeZone'"))
	}
	return errs
}
